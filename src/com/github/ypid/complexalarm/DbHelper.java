...
public final class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String ALARMS_COL_AID               = "aid";
    public static final String ALARMS_COL_VALUE             = "value";
    ...
    public static final String SETTINGS_COL_SID             = "sid";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + DB_TABLE_ALARMS + " (" + ALARMS_COL_AID
                + " INTEGER PRIMARY KEY AUTOINCREMENT," + ALARMS_COL_NAME
                + " TEXT," + ALARMS_COL_VALUE + " TEXT," + ALARMS_COL_ENABLED
                + " UNSIGNED INTEGER (0, 1))");
        
        // |(primary) | (string) | (string) | (1 to 60) | (boolean) | (0 to 100)
        // | (0 to 100) | (0 to 60) |
        // | id | tone_url | tone_name | snooze | vibrate | vol_start | vol_end
        // | vol_time |
        // snooze is in minutes.
        db.execSQL("CREATE TABLE " + DB_TABLE_SETTINGS + " ("
                + SETTINGS_COL_SID + " INTEGER PRIMARY KEY,"
                + SETTINGS_COL_TONE_URL + " TEXT," + SETTINGS_COL_TONE_NAME
                + " TEXT," + SETTINGS_COL_SNOOZE + " UNSIGNED INTEGER (1, 60),"
